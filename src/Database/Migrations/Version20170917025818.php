...
class Version20170917025818 extends AbstractMigration
{
    /**
     * {@inheritdoc}
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_movies (user_id INT UNSIGNED NOT NULL, movie_id INT UNSIGNED NOT NULL, INDEX IDX_A34CF60DA76ED395 (user_id), INDEX IDX_A34CF60D8F93B6FC (movie_id), PRIMARY KEY(user_id, movie_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_movies ADD CONSTRAINT FK_A34CF60DA76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
